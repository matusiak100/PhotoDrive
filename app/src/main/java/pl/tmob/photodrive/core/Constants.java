...
public final class Constants {
    ...
    public static final class Auth {
         ...
         * Account type id
         */
        public static final String BOOTSTRAP_ACCOUNT_TYPE = "pl.tmob.photodrive";

        /**
         * Account name
         */
        public static final String BOOTSTRAP_ACCOUNT_NAME = "PhotoDrive";

        /**
         * Provider id
         */
        public static final String BOOTSTRAP_PROVIDER_AUTHORITY = "pl.tmob.photodrive.sync";
    ...
    public static final class Intent {
         ...
         */
        public static final String INTENT_PREFIX = "pl.tmob.photodrive.";
