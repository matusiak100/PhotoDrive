...
[![Build Status](https://travis-ci.org/AndroidBootstrap/pl-tmob-photodrive.svg?branch=master)](https://travis-ci.org/AndroidBootstrap/pl-tmob-photodrive)

This repository contains the source code for the [PhotoDrive](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=pl.tmob.photodrive).

Please see the [issues](https://github.pl.tmob.photodrive/pl-tmob-photodrive/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about PhotoDrive? Ask away on the [pl-tmob-photodrive discussion forum](https://groups.google.com/forum/#!forum/pl-tmob-photodrive).

<a href="https://play.google.com/store/apps/details?id=pl.tmob.photodrive" alt="Download from Google Play">
...
code for the app will change:
  ...
  - From: __pl.tmob.photodrive__
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____pl.tmob.photodrive__ will be moved to the
new folder __com/notify/app/mobile__.

All import statments that reference the old resources (__R.pl.tmob.photodrive.R__) will now be renamed
...
signed with a different key.  Manually uninstall PhotoDrive from your device and
...
PhotoDrive is a result of a template project I've developed over the years as well as
...
PhotoDrive is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.pl.tmob.photodrive/pl-tmob-photodrive/contributors) on
...
[pull requests](https://github.pl.tmob.photodrive/pl-tmob-photodrive/pulls).
